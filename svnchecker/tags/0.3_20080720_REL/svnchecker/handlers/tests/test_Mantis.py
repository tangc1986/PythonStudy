...
class TestMantis:
    ...
    def testRun(self):
        Mantis.run(self.transaction, self.config, self.module, self.msg, 0)
        Mantis.run(self.transaction, self.config, self.module, self.msg, 1)
